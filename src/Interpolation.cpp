...
void Interpolation::nodalMassFluid(Mesh* mesh, vector<Particle*>* particles) 
{
	// get nodes
	vector<Node*>* nodes = mesh->getNodes();
...
void Interpolation::nodalMomentumFluid(Mesh* mesh, vector<Particle*>* particles) {
...
void Interpolation::nodalInternalForceFluid(Mesh* mesh, vector<Particle*>* particles) {
...
void Interpolation::nodalExternalForceFluid(Mesh* mesh, vector<Particle*>* particles) {
...
void Interpolation::nodalDragForceFluid(Mesh* mesh, vector<Particle*>* particles, Vector3d gravity) {
	...
	for (size_t i = 0; i < particles->size(); ++i) {
		...
		const Vector3d pDragForceFluid = particles->at(i)->getDragForceFluid(gravity);
...
void Interpolation::particleStrainIncrementFluid(Mesh* mesh, vector<Particle*>* particles, double dt) {
