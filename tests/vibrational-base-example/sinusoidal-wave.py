...
amplitud_y = 0.2  # Amplitud de la vibración en Y (m/s^2)
amplitud_z = 0.0  # Amplitud de la vibración en Z (m/s^2)

frecuencia_x = 1.0  # Frecuencia en X (Hz)
frecuencia_y = 1.0  # Frecuencia en Y (Hz)
frecuencia_z = 0.0  # Frecuencia en Z (Hz)

fase_x = np.pi / 1  # Fase en X (radianes)
fase_y = np.pi / 4  # Fase en Y (radianes)
fase_z = np.pi / 8  # Fase en Z (radianes)

duracion = 10.0  # Duración de la vibración (segundos)
paso_tiempo = 0.0005  # Paso de tiempo (segundos)
