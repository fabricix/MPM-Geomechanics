...
namespace Output{
	...
	void updateTerminal(vector<Body*>* bodies, double itime)
	{
		...
		std::cout <<"Energy: "<< std::setw(8) << std::scientific << std::setprecision(4) << DynamicRelaxation::getCurrentKineticEnergy() << " J - ";
    ...
    // Get total kinetic energy
		double ienergy = DynamicRelaxation::getCurrentKineticEnergy();
