...
for mu in mu_values:
    ...
    # plot analytical
    ax.plot(t_values, u_y_analytical, linestyle="solid", label=f"Analytical (μ={mu})")

    # plot MPM results
    ax.plot(mpm_time, mpm_u_y, linestyle="none", label=f"MPM-Geomechanics (μ={mu})", marker=markers[mu_values.index(mu)])
