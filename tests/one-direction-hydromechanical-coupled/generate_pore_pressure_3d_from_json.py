...
unsaturated_analysis = config.get("unsaturated_analysis", False)
...
# Random number generator for saturation
        ...
        if polygon.contains(Point(x, z)):
            for y in y_vals:
                ...
                pressure_data.append({
                    ...
                    "pressure": pressure,
                    "saturation": float(rng.uniform(0.10, 0.99)) if unsaturated_analysis else (1.0)
                })
